...
<head>
    ...
    <title>Tambah Kriteria SPK - E-Raport</title>
            ...
            <div class="bg-white rounded-[2rem] border border-slate-100 shadow-2xl shadow-slate-200/50 overflow-hidden">
                <div class="bg-indigo-950 p-8 text-white relative overflow-hidden">
                    <div class="relative z-10">
                        <h2 class="text-2xl font-bold tracking-tight">Tambah Kriteria SAW</h2>
                        <p class="text-indigo-300 text-sm mt-1">Definisikan kriteria baru untuk perhitungan peringkat siswa.</p>
                    </div>
                ...
                <form action="{{ route('admin.kriteria.store') }}" method="POST" class="p-8 space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="kode" value="{{ old('kode') }}" placeholder="Contoh: C1" 
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="nama" value="{{ old('nama') }}" placeholder="Contoh: Nilai Akademik" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="bobot" step="0.01" min="0" max="1" value="{{ old('bobot') }}" placeholder="Contoh: 0.25 (untuk 25%)" 
                                       class="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all outline-none" required>
                            </div>
                            <p class="text-[10px] text-slate-400 mt-1 ml-1 italic">*Gunakan titik (.) untuk desimal.</p>
